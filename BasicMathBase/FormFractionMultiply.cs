...
{
    public partial class FormFractionMultiply : Form
    {
        public FormFractionMultiply()
        {
            InitializeComponent();
            customDesign();
        }
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (run)
            {
                ...
                string answer = "";
                var systemAnswer = MathMethods.FractionMultiply(numerator, denominator, numerator2, denominator2);
